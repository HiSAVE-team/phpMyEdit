...
/* $Platon: phpMyEdit/extensions/phpMyEdit-messages.class.php,v 1.16 2007-11-01 20:21:24 nepto Exp $ */
...
class phpMyEdit_messages extends phpMyEdit
{
    function phpMyEdit_messages($opts) /* {{{ */
    {
        ...
        $ezin_admin_article_up   = $this->get_sys_cgi_var('ezin_admin_article_up');
        $ezin_admin_article_down = $this->get_sys_cgi_var('ezin_admin_article_down');
    ...
    function display_record_buttons($position) /* {{{ */
    {
        ...
        echo '<tr class="',$this->getCSSclass('navigation', $position),'">',"\n";
        echo '<td class="',$this->getCSSclass('buttons', $position),'">',"\n";
        $this->print_article_select($ezin_admin_article, 1, $position);
        echo '</td>',"\n";
